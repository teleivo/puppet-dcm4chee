...
describe 'dcm4chee::staging::weasis', :type => :class do
  ...
  describe 'without parameters' do
    ...
    it { is_expected.to contain_file('/opt/dcm4chee/staging/dcm4chee-2.18.0-mysql/server/default/deploy/weasis.war')
          .with({
            'ensure'  => 'present',
            'owner'   => 'dcm4chee',
            'group'   => 'dcm4chee',
    ...
    it { is_expected.to contain_file('/opt/dcm4chee/staging/dcm4chee-2.18.0-mysql/server/default/deploy/weasis-pacs-connector.war')
          .with({
            'ensure'  => 'present',
            'owner'   => 'dcm4chee',
            'group'   => 'dcm4chee',
    ...
    it { is_expected.to contain_file('/opt/dcm4chee/staging/dcm4chee-2.18.0-mysql/server/default/deploy/dcm4chee-web-weasis.jar')
          .with({
            'ensure'  => 'present',
            'owner'   => 'dcm4chee',
            'group'   => 'dcm4chee',
